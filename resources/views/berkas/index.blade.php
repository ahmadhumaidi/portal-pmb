...
<div class="card dashboard-card border-0">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive"><table class="table align-middle"><thead><tr><th>No.</th><th>Kode</th><th>Mahasiswa</th><th class="text-center">Ijazah</th><th class="text-center">Transkrip</th><th class="text-center">KTP</th><th class="text-center">KK</th><th class="text-center">Foto</th><th>Status</th><th>Keterangan</th><th></th></tr></thead><tbody>
            @forelse ($berkas as $item)
                <tr>
                    ...
                    <td class="text-center">@if ($item->transkrip_awal_path)<i class="bi bi-check-circle-fill text-success"></i>@else<span class="text-muted">-</span>@endif</td>
                    ...
                    <td><a href="{{ route('berkas.show', $item) }}" class="btn btn-sm btn-outline-primary">Detail</a></td>
                </tr>
            @empty
                <tr><td colspan="11" class="text-center py-5 text-muted">Belum ada data berkas.</td></tr>
            @endforelse
